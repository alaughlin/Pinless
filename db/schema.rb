...
ActiveRecord::Schema.define(version: 20140827202855) do
  ...
  add_index "friend_requests", ["requester_id", "requestee_id"], name: "index_friend_requests_on_requester_id_and_requestee_id", unique: true, using: :btree
