...
Card.create(user_id: luke.id, board_id: rebel_alliance.id, title: "X-Wing Fighter", description: "Love flying these!", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: luke.id, board_id: millenium_falcon.id, title: "Han's Ship", description: "Too many close calls here", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: luke.id, board_id: light_side.id, title: "My lightsaber", description: "Never leave home without it", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: luke.id, board_id: dagobah.id, title: "Training Grounds", description: "Slimy mudhole, indeed", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: vader.id, board_id: death_star.id, title: "Superlaser Cannon", description: "Ok, it's kind of cool", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: vader.id, board_id: empire.id, title: "Galactic Senate", description: "Remember these jokers?", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: vader.id, board_id: dark_side.id, title: "Darth Maul", description: "Obi Wan took him down", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: leia.id, board_id: rebel_alliance.id, title: "Throne Room", description: "Ceremony after takedown of Death Star", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: leia.id, board_id: light_side.id, title: "Luke training", description: "He's a lot better now, I think", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: han.id, board_id: rebel_alliance.id, title: "", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: han.id, board_id: millenium_falcon.id, title: "My Home", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: han.id, board_id: cloud_city.id, title: "My Home", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: obi_wan.id, board_id: tatooine.id, title: "Meeting Luke", description: "Finally", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: obi_wan.id, board_id: rebel_alliance.id, title: "", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: obi_wan.id, board_id: light_side.id, title: "My lightsaber", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: obi_wan.id, board_id: dagobah.id, title: "My Master's Home", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: lando.id, board_id: millenium_falcon.id, title: "Lost Gems", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: lando.id, board_id: cloud_city.id, title: "My Home", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: emperor.id, board_id: death_star.id, title: "View from the Top", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: emperor.id, board_id: empire.id, title: "My Throne", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: emperor.id, board_id: dark_side.id, title: "Darkness", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: yoda.id, board_id: rebel_alliance.id, title: "The Old Days", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: yoda.id, board_id: light_side.id, title: "Training Luke", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: yoda.id, board_id: dagobah.id, title: "My Home", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))

Card.create(user_id: boba_fett.id, board_id: tatooine.id, title: "Jaba's Palace", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
Card.create(user_id: boba_fett.id, board_id: empire.id, title: "Meeting Vader", description: "Never going back", image: File.new("#{Rails.root}/seeds/images/lars_homestead.jpg"))
