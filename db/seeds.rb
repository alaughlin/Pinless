...
User.create!(username: "Luke", password: '123456', email: 'luke@rebel.com', avatar: File.new("#{Rails.root}/seeds/images/luke.png"))
User.create!(username: "Vader", password: '123456', email: 'vader@empire.com', avatar: File.new("#{Rails.root}/seeds/images/vader.jpeg"))
User.create!(username: "Leia", password: '123456', email: 'leia@rebel.com', avatar: File.new("#{Rails.root}/seeds/images/leia.jpg"))
User.create!(username: "Han", password: '123456', email: 'han@rebel.com', avatar: File.new("#{Rails.root}/seeds/images/han.jpg"))
User.create!(username: "Obi Wan", password: '123456', email: 'obiwan@rebel.com', avatar: File.new("#{Rails.root}/seeds/images/obi_wan.jpg"))
User.create!(username: "Lando", password: '123456', email: 'lando@rebel.com', avatar: File.new("#{Rails.root}/seeds/images/lando.jpg"))
User.create!(username: "Emperor", password: '123456', email: 'emperor@empire.com', avatar: File.new("#{Rails.root}/seeds/images/emperor.jpeg"))
User.create!(username: "Yoda", password: '123456', email: 'yoda@rebel.com', avatar: File.new("#{Rails.root}/seeds/images/yoda.png"))
User.create!(username: "Boba Fett", password: '123456', email: 'bobafett@empire.com', avatar: File.new("#{Rails.root}/seeds/images/boba_fett.jpg"))
...
Board.create!(user_id: leia.id, public: true, title: "Rebel Alliance", description: "Down with the Empire", avatar: File.new("#{Rails.root}/seeds/images/rebel.png"))
Board.create!(user_id: emperor.id, public: true, title: "Empire", description: "Everything that has transpired has done so according to my design", avatar: File.new("#{Rails.root}/seeds/images/empire.png"))
...
card = Card.create!(user_id: luke.id, board_id: millenium_falcon.id, title: "The Cockpit", description: "Too many close calls here", image: File.new("#{Rails.root}/seeds/images/cards/cockpit.jpg"))
CardLike.create(card_id: card.id, user_id: obi_wan.id)
CardLike.create(card_id: card.id, user_id: leia.id)
CardLike.create(card_id: card.id, user_id: han.id)
